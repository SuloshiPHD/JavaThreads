...
/**
 * A program to find the smallest of all greater numbers.
 * Have the function MathChallenge(num) take the num parameter being passes and return the
 * next number greater than num using the same digits. for example: if num is 123 return 132,
 * if it's 12453 it returns 12534. if a number has no greater permutations, return -1
 **/
